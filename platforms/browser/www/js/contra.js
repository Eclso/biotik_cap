...
document.addEventListener("deviceready", onDeviceReady, false);
                ...
                function svgData(temp){
                   ...
                   if(a>700){
                    ...
                    $(".selectContraWrapper").html('<svg  xmlns="http://www.w3.org/2000/svg" xml:space="preserve" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" style="height:'+h+'px;width:100%;" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 240 180" xmlns:xlink="http://www.w3.org/1999/xlink"> ' + temp + '</svg>')
                }
